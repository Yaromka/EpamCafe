...
<div class="container theme-showcase" role="main">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <br>
            <div>
                <h2><fmt:message key="label.account.edituser" bundle="${rb}"/></h2>
            </div>
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls ">
                            ...
                            <a class="btn btn-success" href="/controller?command=get_page&jsp_page=CLIENT_CHANGE_PASS_JSP"><fmt:message key="label.account.changepass.changepass" bundle="${rb}"/></a>
                        </div>
                    </div>
                </fieldset>
            </form>
